...
START "Jtc.Optimization.Api" "cmd.exe" "/C ""C:\Program Files\dotnet\dotnet.exe"" run --project Jtc.Optimization.Api\Jtc.Optimization.Api.csproj  --no-build -c Debug"
...
FOR /L %%A IN (1,1,10) DO (
	...
	"C:\Program Files\dotnet\dotnet.exe" run --project Jtc.Optimization.BlazorClient\Jtc.Optimization.BlazorClient.csproj -c Debug  
)
